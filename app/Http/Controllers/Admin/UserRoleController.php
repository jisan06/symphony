...
class UserRoleController extends Controller
{
    ...
    {   $userRoles = UserRoles::orderBy('id','ASC')->get();
       return view('admin.userRole.index')->with(compact('userRoles'));
    }
    ...
    public function adduserRole(){
        return view('admin.userRole.adduserRole');
    }
    ...
    public function edituserRole($id){
        ...
        return view('admin.userRole.updateuserRole')->with(compact('userRoles'));
    }

...
<div class="row">
    <div class="col-12">
        ...
        <span class="shortlink">
         ...
         <a class="btn btn-info" onclick="if (confirm(&quot;Are you sure you want Delete ?&quot;)) { return true; } return false;"  href="{{ route('chooseUs.delete',$chooseUs->id) }}"><i class="fa fa-trash"></i> Delete</a>
         <a class="btn btn-info"  href="{{ route('chooseUs.add') }}"><i class="fa fa-plus"></i> Add New</a>
        </span>
            <div class="card-body">
                ...
                <div id="addNewProduct" class="">
                    <div class="">        
                        <div class="">
                            ...
                            <form class="form-horizontal" action="{{ route('chooseUs.edit',$chooseUs->id) }}" method="POST" enctype="multipart/form-data" name="form">
                            {{ csrf_field() }}
                        ...
                        @endif
                            <div class="modal-body">
                                 <input type="hidden" name="aboutCompanyId" value="{{$chooseUs->id}}">
                                ...
                                <div class="form-group row {{ $errors->has('title1') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-danger" placeholder="first title" name="title1" value="{{ @$chooseUs->title1 }}">
                                ...
                                <div class="form-group row {{ $errors->has('title2') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-danger" placeholder="second title" name="title2" value="{{ @$chooseUs->title2 }}">
                                ...
                                <div class="form-group row {{ $errors->has('image') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if (file_exists(@$chooseUs->image)) { ?> 
                                        <img src="{{asset('/').@$chooseUs->image}}" style="height: 90px;">
                                        <?php }else{ ?>
                                ...
                                <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control tinymce" name="description" style="min-height: 250px"><?php echo $chooseUs->description; ?></textarea>
                                 ...
                                 <div class="form-group row {{ $errors->has('orderBy') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number"   name="orderBy" value="{{ $chooseUs->orderBy }}" required>
...
<script type="text/javascript">
        document.forms['form'].elements['status'].value = "{{$chooseUs->status}}";
</script>

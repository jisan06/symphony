...
<div class="row">
    <div class="col-12">
        ...
        <span class="shortlink">
             ...
             <a class="btn btn-info" onclick="if (confirm(&quot;Are you sure you want Delete ?&quot;)) { return true; } return false;"  href="{{ route('articles.delete',$articles->id) }}"><i class="fa fa-trash"></i> Delete</a>
             <a class="btn btn-info"  href="{{ route('articles.add') }}"><i class="fa fa-plus"></i> Add New</a>
        </span>
            <div class="card-body">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                               <div class="form-group {{ $errors->has('parentMenu') ? ' has-danger' : '' }}">
                                                    <label for="inputHorizontalDnger">Add To Parent Menu</label>
                                                    <select class="form-control chosen-select" name="parentMenu">
                                                        ...
                                                        ?>
                                                            <option {{@$selected}} value="{{$menu->id}}">{{$menu->articleName}}</option>
                                                        <?php } ?>
                                                    </select>
                                                </div> 
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row {{ $errors->has('parentArticle') ? ' has-danger' : '' }}">
                                                    <label for="inputHorizontalDnger">Article Parent</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="inputHorizontalDnger">Article Name</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('firstInnerImage') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" class="form-control form-control-danger" name="firstInnerImage">
                                             <span class="imageSizeInfo">/* Standard Image Size : 110*100 px */ <br></span>

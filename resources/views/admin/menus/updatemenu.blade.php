    ...
    <div class="col-12">
        <div class="card">
            <span class="shortlink">
                 ...
                 <a class="btn btn-info" onclick="if (confirm(&quot;Are you sure you want Delete ?&quot;)) { return true; } return false;"  href="{{ route('menu.delete',$menu->id) }}"><i class="fa fa-trash"></i> Delete</a>
                 <a class="btn btn-info"  href="{{ route('menuadd.page') }}"><i class="fa fa-plus"></i> Add New</a>

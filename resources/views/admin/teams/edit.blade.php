               ...
               <div class="row">
                    ...
                    <div class="col-sm-6">
                          <span class="shortlink">
                             ...
                             <a class="btn btn-info" onclick="if (confirm(&quot;Are you sure you want Delete ?&quot;)) { return true; } return false;"  href="{{ route('team.delete',$team->id) }}"><i class="fa fa-trash"></i> Delete</a>
                             <a class="btn btn-info"  href="{{ route('team.add') }}"><i class="fa fa-plus"></i> Add New</a>
                        </span>
                    </div>
                </div>
                <?php

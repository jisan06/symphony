...
<div class="row">
    ...
    <span class="shortlink">
         <a class="btn btn-info"  href="{{ route('usermenu.index') }}">Go Back</a>
    </span>
            <div class="card-body">
                <?php
                ...
                ?>
                <h4 class="card-title">Add User Menu</h4>
        ...
        @endif
            ...
            <br>
                ...
                <div class="form-group row {{ $errors->has('menuLink') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-danger" placeholder="Menu link" name="menuLink" value="{{ old('menuLink') }}">

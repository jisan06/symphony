...
<div class="row">
    <div class="col-12">
        ...
        <span class="shortlink">
         ...
         <a class="btn btn-info" onclick="if (confirm(&quot;Are you sure you want Delete ?&quot;)) { return true; } return false;"  href="{{ route('testimonial.delete',$testimonial->id) }}"><i class="fa fa-trash"></i> Delete</a>
         <a class="btn btn-info"  href="{{ route('testimonial.add') }}"><i class="fa fa-plus"></i> Add New</a>
        </span>
            <div class="card-body">
                        ...
                        @endif
                            <div class="modal-body">
                                ...
                                <div class="form-group row {{ $errors->has('information') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-danger" placeholder="second title" name="information" value="{{ @$testimonial->information }}">

                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="shortlink">
                             ...
                             <a class="btn btn-info" onclick="if (confirm(&quot;Are you sure you want Delete ?&quot;)) { return true; } return false;"  href="{{ route('blog.delete',$articles->id) }}"><i class="fa fa-trash"></i> Delete</a>
                             <a class="btn btn-info"  href="{{ route('blogadd.page') }}"><i class="fa fa-plus"></i> Add New</a>
                        </span>
                   </div>
                </div>
                ...
                <div id="addNewProduct" class="">
                    <div class="">        
                        <div class="">
                            ...
                            <form class="form-horizontal" action="{{ route('blog.update',$articles->id) }}" method="POST" enctype="multipart/form-data" name="form">
                            {{ csrf_field() }}
